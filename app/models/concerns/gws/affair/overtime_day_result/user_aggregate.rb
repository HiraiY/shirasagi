  ...
  module ClassMethods
    def user_aggregate
      ...
      aggregation.each do |i|
        ...
        prefs[user_id] ||= {}
        prefs[user_id]["detail_subtractor"] ||= Gws::Affair::Subtractor.new(threshold)
        prefs[user_id]["total_subtractor"] ||= Gws::Affair::Subtractor.new(threshold)
        ...
        prefs[user_id]["under_threshold"]["duty_day_time_minute"] += detail_under_minutes[0]
