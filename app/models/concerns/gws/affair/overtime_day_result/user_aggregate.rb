  ...
  module ClassMethods
    def user_aggregate
      ...
      aggregation.each do |i|
        ...
        detail_under_minutes, detail_over_minutes = subs[user_id]["detail_subtractor"].subtract(d_d_m, d_n_m, i_w_m, l_d_m, l_n_m, w_c_m)
        ...
        prefs[user_id][capital_id]["under_threshold"]["duty_day_in_work_time_minute"] += detail_under_minutes[2]
        prefs[user_id][capital_id]["under_threshold"]["leave_day_time_minute"] += detail_under_minutes[3]
        prefs[user_id][capital_id]["under_threshold"]["leave_night_time_minute"] += detail_under_minutes[4]
        ...
        prefs[user_id][0]["under_threshold"]["duty_day_in_work_time_minute"] += detail_under_minutes[2]
        prefs[user_id][0]["under_threshold"]["leave_day_time_minute"] += detail_under_minutes[3]
        prefs[user_id][0]["under_threshold"]["leave_night_time_minute"] += detail_under_minutes[4]
        ...
        prefs[user_id][capital_id]["over_threshold"]["duty_day_time_minute"] += (detail_over_minutes[0] + detail_over_minutes[2])
        prefs[user_id][capital_id]["over_threshold"]["duty_night_time_minute"] += detail_over_minutes[1]
        prefs[user_id][capital_id]["over_threshold"]["leave_day_time_minute"] += detail_over_minutes[3]
        prefs[user_id][capital_id]["over_threshold"]["leave_night_time_minute"] += detail_over_minutes[4]
        ...
        prefs[user_id][0]["over_threshold"]["duty_day_time_minute"] += (detail_over_minutes[0] + detail_over_minutes[2])
        prefs[user_id][0]["over_threshold"]["duty_night_time_minute"] += detail_over_minutes[1]
        prefs[user_id][0]["over_threshold"]["leave_day_time_minute"] += detail_over_minutes[3]
        prefs[user_id][0]["over_threshold"]["leave_night_time_minute"] += detail_over_minutes[4]
