module Gws::Workflow
  class Initializer
    ...
    Gws::Role.permission :delegate_all_gws_workflow_files, module_name: 'gws/workflow'
    Gws::Role.permission :delegate_private_gws_workflow_files, module_name: 'gws/workflow'
